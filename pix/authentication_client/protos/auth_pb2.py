...
_PROFILEOBJECT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ProfileObject.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='lastname', full_name='ProfileObject.lastname', index=1,
...
_AUTHOBJECT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='profile', full_name='AuthObject.profile', index=2,
...
_SIGNUPREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='profile', full_name='SignupRequest.profile', index=4,
...
_AUTHOBJECT.fields_by_name['profile'].message_type = _PROFILEOBJECT
_SIGNUPREQUEST.fields_by_name['profile'].message_type = _PROFILEOBJECT
_SIGNUPRESPONSE.fields_by_name['auth'].message_type = _AUTHOBJECT
_SIGNINRESPONSE.fields_by_name['auth'].message_type = _AUTHOBJECT
DESCRIPTOR.message_types_by_name['ProfileObject'] = _PROFILEOBJECT
...
ProfileObject = _reflection.GeneratedProtocolMessageType('ProfileObject', (_message.Message,), {
  'DESCRIPTOR' : _PROFILEOBJECT,
  '__module__' : 'app.services.auth.auth_pb2'
  # @@protoc_insertion_point(class_scope:ProfileObject)
  })
_sym_db.RegisterMessage(ProfileObject)
